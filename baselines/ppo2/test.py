...
def test(env_id, num_timesteps, seed, model_path, target=0, num_iter=300):
...
def main():
    ...
    #Maml Aligner (target: 1)
    #test(args.env, num_timesteps=args.num_timesteps, seed=args.seed,
    #      #model_path='/tmp/openai-2018-01-19-19-13-58-892638/checkpoints/00130')
    #      #model_path='/tmp/openai-2018-01-20-15-12-34-106221/checkpoints/00160') # With Fully Trained Shuffle&Learn Model
    """
    for x in range(10,400,30):
        print('%05d : '%(x),end='')
        test(args.env, num_timesteps=args.num_timesteps, seed=args.seed,
            model_path='/tmp/openai-2018-01-19-19-13-58-892638/checkpoints/%05d'%(x))
    """
